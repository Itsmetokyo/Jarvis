...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'allenxaztec;русский;https://graph.org/file/58ea74675af7836579a3a.jpg',
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_d1a2_bc25_a446_3a5e_776d_47ef_d044_6a53',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'allenxaztec🩵',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;allenX-ᴍᴅ;https://graph.org/file/58ea74675af7836579a3a.jpg',
  MENU_FONT: process.env.MENU_FONT || "0;0",
  SUDO: process.env.SUDO || '43664779422222,919496473494,917306753692,917012600235',
  ...
  BOT_INFO: process.env.BOT_INFO || 'allenxaztec;русский;https://graph.org/file/1506e5842805b0968c5cf.mp4',
